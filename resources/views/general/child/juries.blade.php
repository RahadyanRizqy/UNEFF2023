		...
		<div class="row">
			<div class="col-12 text-center">
				...
				<ol class="breadcrumb justify-content-center p-0 m-0">
				  <li class="breadcrumb-item active">Berikut adalah para juri yang akan ada di acara ini</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="block">
			...
			<div class="row row-margin">
				<div class="col-lg-7 col-md-6 align-self-center">
					<div class="content-block">
						<div class="name">
							<h3 class="jury-two-name">Arief Retno Pribadi I.C.S</h3>
						</div>
						<div class="profession">
			...
			<div class="row row-margin">
				...
				<div class="col-lg-7 col-md-6 align-self-center">
					<div class="content-block">
						<div class="name">
							<h3 class="jury-three-name">Timo Tjahjanto</h3>
						</div>
						<div class="profession">
							<p>Sutradara</p>
						</div>
						<div class="details">
							<p align="justify">Timothy Tjahjanto adalah sutradara, produser, dan penulis skenario asal Indonesia. Ia dikenal karena karya-karyanya dengan genre horor dan aksi laga. Ia juga menjalankan perusahaan produksi film Frontier Pictures.
							<br>
							</p>
						</div>
					</div>
